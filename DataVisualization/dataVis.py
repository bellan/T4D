...
for particle_index in range(PARTICLE_NUMBER):
    ...
    ax_t.errorbar(z, pre_t, yerr=pre_st, ls=" ", fmt="o", elinewidth=1, capsize=1, label="predicted", color="red")
    ax_t.errorbar(z, fil_t, yerr=fil_st, ls=" ", fmt="o", elinewidth=1, capsize=1, label="filtered", color="blue")
    ...
    ax_x.errorbar(z, pre_x, yerr=pre_sx, ls=" ", fmt="o", elinewidth=1, capsize=1, label="predicted", color="red")
    ax_x.errorbar(z, fil_x, yerr=fil_sx, ls=" ", fmt="o", elinewidth=1, capsize=1, label="filtered", color="blue")
    ...
    ax_y.errorbar(z, pre_y, yerr=pre_sy, ls=" ", fmt="o", elinewidth=1, capsize=1, label="predicted", color="red")
    ax_y.errorbar(z, fil_y, yerr=fil_sy, ls=" ", fmt="o", elinewidth=1, capsize=1, label="filtered", color="blue")
    ...
    ax_yz.errorbar(z, pre_yz, yerr=pre_syz, ls=" ", fmt="o", elinewidth=1, capsize=1, label="predicted", color="red")
    ax_yz.errorbar(z, fil_yz, yerr=fil_syz, ls=" ", fmt="o", elinewidth=1, capsize=1, label="filtered", color="blue")
